...
```
  inventories
    ...
    local.ini               # inventory file for development stage
    staging1.ini            # inventory file for test1 stage
    staging2.ini            # inventory file for test2 stage
  ...
  group_vars/
      ...
      webservers/           # here we assign variables to webservers groups
          ...
          nginx.yml         # ""
      database/             # here we assign variables to database groups
          database.yml      # Each file will correspond to a role i.e. database
          database-password.yml   # Encrypted password file
  plays/
      ansible.cfg           # Ansible.cfg file that holds all ansible config
      webservers.yml        # playbook for webserver tier
      database.yml          # playbook for database tier
